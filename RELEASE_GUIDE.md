...
当某位数字达到 10 时，自动向前进一位：

| 版本序列 | versionCode | 说明 |
|--------|-----------|------|
| 2.2.1 | 20201 | 初始版本 |
| 2.2.2 | 20202 | patch 递增 |
| ... | ... | ... |
| 2.2.9 | 20209 | patch = 9 |
| **2.3.0** | **20300** | **patch=10 → 进位到 minor** ✅ |
| 2.3.1 | 20301 | 继续递增 |
| ... | ... | ... |
| 2.9.9 | 20909 | |
| **3.0.0** | **30000** | **minor=10 → 进位到 major** ✅ |

### 当前版本

- **versionName**: v2.2.1
- **versionCode**: 20201 (= 2×10000 + 2×100 + 1)

### 下一版本选择

| 类型 | 版本号 | versionCode | 用途 |
|------|--------|-----------|------|
| 修复 | 2.2.2 | 20202 | 修复 bug |
| 新功能 | 2.3.0 | 20300 | 添加新功能 |
| 大版本 | 3.0.0 | 30000 | 重大更新 |

✅ **脚本自动计算 versionCode，无需手动！**
